...
# data
data_map = enmap.read_map(baseline_path + f'/rawmaps_241108/{autils.get_map_name(args.dust_type, args.dust_freq, sim_id=1000)}') 
...
for jj in my_tasks:
    ...
    for set in range(2):
        ...
        mf_ph_data[f'mf_grad_set{set}'] = rg_ph_mean + 1j * ig_ph_mean
